namespace CKCharaDataEditor
{
    partial class SkillPointForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            skillPointNumeric1 = new CKCharaDataEditor.Control.SkillPointNumeric();
            skillPointNumeric2 = new CKCharaDataEditor.Control.SkillPointNumeric();
            skillPointNumeric3 = new CKCharaDataEditor.Control.SkillPointNumeric();
            skillPointNumeric4 = new CKCharaDataEditor.Control.SkillPointNumeric();
            skillPointNumeric5 = new CKCharaDataEditor.Control.SkillPointNumeric();
            skillPointNumeric6 = new CKCharaDataEditor.Control.SkillPointNumeric();
            skillPointNumeric7 = new CKCharaDataEditor.Control.SkillPointNumeric();
            skillPointNumeric8 = new CKCharaDataEditor.Control.SkillPointNumeric();
            skillPointNumeric9 = new CKCharaDataEditor.Control.SkillPointNumeric();
            skillPointNumeric10 = new CKCharaDataEditor.Control.SkillPointNumeric();
            skillPointNumeric11 = new CKCharaDataEditor.Control.SkillPointNumeric();
            skillPointNumeric12 = new CKCharaDataEditor.Control.SkillPointNumeric();
        ...
        private Control.SkillPointNumeric skillPointNumeric12;
    }
}