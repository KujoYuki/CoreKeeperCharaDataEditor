...
namespace CKCharaDataEditor.Models.Pet
{
    public class PetResource
    {
        ...
        public static IReadOnlyCollection<(int Id, string MeleeRangeDisplayName, string BuffDisplayName, string MeleeRangeDescription, string BuffDescription)> TalentDescriptionDict =
            new List<(int Id, string MeleeRangeDisplayName, string BuffDisplayName, string MeleeRangeDescription, string BuffDescription)>
            {
                ...
                (21, "未定義キー", "ウィングエスケープ", "移動不可および気絶時間減少+0%", "飼い主へのバフ:移動不可および気絶時間減少+10%"),
                (22, "エネルギータップ", "未定義キー", "ヒット時にマナを得られる確率+10%", "飼い主へのバフ:ヒット時にマナを得られる確率+1%"),
                (23, "未定義キー", "マナボウル", "+2.0マナ/毎秒", "飼い主へのバフ:+2.0マナ/毎秒"),
                (24, "未定義キー", "神秘術の野獣", "魔法ダメージ+10.0%", "飼い主へのバフ:魔法ダメージ+3.0%"),
                (25, "未定義キー", "怒れる群体", "ミニオン攻撃スピード+0.0%", "飼い主へのバフ:ミニオン攻撃スピード+12.0%"),
                (26, "局地的放射性降下物", "放射能汚染の匂い", "周辺の敵全員に20の放射線ダメージを2秒ごとに与える", "飼い主へのバフ:周辺の敵全員に0の放射線ダメージを2秒ごとに与える"),
                (27, "未定義キー", "レーザーポインター遊び", "ミニオンクリティカルヒット確率+0%", "飼い主へのバフ:ミニオンクリティカルヒット確率+3%"),
                (28, "未定義キー", "スキンブレイク", "ミニオンのクリティカルヒットダメージ+0%", "飼い主へのバフ:ミニオンのクリティカルヒットダメージ+30%"),
                (29, "未定義キー", "戦闘狂", "ミニオンダメージ+0.0%", "飼い主へのバフ:ミニオンダメージ+8.0%"),
                (30, "未定義キー", "穀潰しの威圧", "ボスへのミニオンの与ダメージ+0%", "飼い主へのバフ:ボスへのミニオンの与ダメージ+15%"),
