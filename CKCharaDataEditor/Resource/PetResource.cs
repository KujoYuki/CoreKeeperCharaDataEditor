    ...
    public class PetResource
    {
        ...
        public static IReadOnlyCollection<(int Id, string MeleeRangeDisplayName, string BuffDisplayName, string MeleeRangeDescription, string BuffDescription)> TalentDescriptionDict = 
            new List<(int Id, string MeleeRangeDisplayName, string BuffDisplayName, string MeleeRangeDescription, string BuffDescription)>
            {
                ...
                (33, "Missing", "Missing", "ペットのヒットでライフ+0", "飼い主へのバフ:ペットのヒットでライフ+0"),
            };
            ...
            = new Dictionary<(PetId petType, PetColor color), string>
        {
            ...
            { (PetId.PetWarlock,PetColor.Color_1) ,"黒(Black)" },
            { (PetId.PetWarlock,PetColor.Color_2) ,"青(Blue)" },
            { (PetId.PetWarlock,PetColor.Color_3) ,"茶(Brown)" },
            { (PetId.PetWarlock,PetColor.Color_4) ,"緑(Green)" },
            { (PetId.PetWarlock,PetColor.Color_5) ,"紫(Purple)" },
            { (PetId.PetWarlock,PetColor.Color_6) ,"赤(Red)" },
            { (PetId.PetWarlock,PetColor.Color_7) ,"黄(Yellow)" },
