...
- 元データはPugStormが提供しているものですが、必ず最新のバージョンに一致しているとは限りません。例えば1.1.2.5において提供されているデータは、1.0.0.1で修正されたId間違いの8331が森の採掘スポットより低確率で出るデータになっていますが、実際は8331は出ないため、ゲーム内では参照されていない可能性が非常に高いです。
